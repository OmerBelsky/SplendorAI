...
if __name__ == '__main__':
    ...
    game.take_unique_coins(players[1], rgu)
    game.take_unique_coins(players[2], rgu)
    game.take_unique_coins(players[3], rgu)
    game.take_double_coins(players[0], GemColor.BLACK)
    game.take_unique_coins(players[1], rgu)
    game.take_unique_coins(players[2], rgu)
    game.take_unique_coins(players[3], rgu)
    game.take_double_coins(players[0], GemColor.WHITE)
    game.take_unique_coins(players[1], rgu)
    game.mortgage_card(players[2], 1, 1)
    game.mortgage_card(players[3], 1, 1)

    game.take_unique_coins(players[0], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1})
    game.take_unique_coins(players[1], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1, GemColor.WHITE: 1})
    game.take_unique_coins(players[2], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1})
    game.take_unique_coins(players[3], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1, GemColor.BLACK: 1})
