...
if __name__ == '__main__':
    ...
    game.take_three_coins(players[0], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1})
    game.take_three_coins(players[1], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1, GemColor.WHITE: 1})
    game.take_three_coins(players[2], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1})
    game.take_three_coins(players[3], {GemColor.WHITE: 1, GemColor.BLACK: 1, GemColor.RED: 1}, {GemColor.RED: 1, GemColor.BLACK: 1})
